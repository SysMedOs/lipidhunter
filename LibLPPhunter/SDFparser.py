...
class MolReader(object):
    ...
    def get_pl_backbone(self, usr_mol):
        ...
        :param usr_mol:
        :type usr_mol: rdkit.Chem.Mol
        :return _pl_dct: Dictionary contains ``smiles`` and ``m/z`` of phospholipid sn1, sn2 and head group.
        """
    ...
    def _re_checker(self, usr_patt, usr_smi, usr_mol):
        ...
        :param usr_patt: the regular expression pattern built to checker
        :type usr_patt: re.complie
        :param usr_smi: The ``smiles`` from user settings
        :type usr_smi: str
        :param usr_mol: The ``mol`` object generated by pr
        :type usr_mol: Chem.Mol
        :return: Dictionary contains ``smiles`` and ``m/z`` of phospholipid sn1, sn2 and head group.
        :rtype: dict
        """
